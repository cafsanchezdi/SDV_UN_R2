...
#include "sdv_serial/msg/detail/tag_rfid__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sdv_serial::msg::TagRfid & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sdv_serial::msg::TagRfid & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_serial::msg::TagRfid;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sdv_serial::msg::TagRfid *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_serial::msg::TagRfid *>(
    untyped_ros_message);
...
{
  return &sdv_serial::msg::typesupport_fastrtps_cpp::_TagRfid__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_serial, msg, TagRfid)() {
  return &sdv_serial::msg::typesupport_fastrtps_cpp::_TagRfid__handle;
}
