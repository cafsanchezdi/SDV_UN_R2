...
#include "sdv_serial/msg/detail/ultrasound__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sdv_serial::msg::Ultrasound & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sdv_serial::msg::Ultrasound & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sdv_serial
max_serialized_size_Ultrasound(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_serial::msg::Ultrasound;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_sdv_serial
max_serialized_size_key_Ultrasound(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const sdv_serial::msg::Ultrasound *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_serial::msg::Ultrasound *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Ultrasound__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const sdv_serial::msg::Ultrasound *>(
...
static size_t _Ultrasound__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Ultrasound(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Ultrasound__callbacks = {
  "sdv_serial::msg",
  "Ultrasound",
...
static rosidl_message_type_support_t _Ultrasound__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Ultrasound__callbacks,
...
{
  return &sdv_serial::msg::typesupport_fastrtps_cpp::_Ultrasound__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sdv_serial, msg, Ultrasound)() {
  return &sdv_serial::msg::typesupport_fastrtps_cpp::_Ultrasound__handle;
}
