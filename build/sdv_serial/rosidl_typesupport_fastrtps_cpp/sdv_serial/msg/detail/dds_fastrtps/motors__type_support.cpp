...
#include "sdv_serial/msg/detail/motors__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_serial::msg::Motors;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sdv_serial::msg::Motors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sdv_serial::msg::Motors *>(
    untyped_ros_message);
...
{
  return &sdv_serial::msg::typesupport_fastrtps_cpp::_Motors__handle;
}
