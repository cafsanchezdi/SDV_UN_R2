...
#ifndef SDV_SERIAL__MSG__DETAIL__SDV_STATUS__STRUCT_HPP_
#define SDV_SERIAL__MSG__DETAIL__SDV_STATUS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sdv_serial__msg__SdvStatus __attribute__((deprecated))
#else
# define DEPRECATED__sdv_serial__msg__SdvStatus __declspec(deprecated)
#endif
...
struct SdvStatus_
{
  ...
  // pointer types
  using RawPtr =
    sdv_serial::msg::SdvStatus_<ContainerAllocator> *;
  using ConstRawPtr =
    const sdv_serial::msg::SdvStatus_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sdv_serial::msg::SdvStatus_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sdv_serial::msg::SdvStatus_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sdv_serial::msg::SdvStatus_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sdv_serial::msg::SdvStatus_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sdv_serial::msg::SdvStatus_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sdv_serial::msg::SdvStatus_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sdv_serial::msg::SdvStatus_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sdv_serial__msg__SdvStatus
    std::shared_ptr<sdv_serial::msg::SdvStatus_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sdv_serial__msg__SdvStatus
    std::shared_ptr<sdv_serial::msg::SdvStatus_<ContainerAllocator> const>
...
using SdvStatus =
  sdv_serial::msg::SdvStatus_<std::allocator<void>>;
...
#endif  // SDV_SERIAL__MSG__DETAIL__SDV_STATUS__STRUCT_HPP_
