...
#ifndef SDV_SERIAL__MSG__DETAIL__TAG_RFID__TRAITS_HPP_
#define SDV_SERIAL__MSG__DETAIL__TAG_RFID__TRAITS_HPP_
...
inline void to_yaml(
  const sdv_serial::msg::TagRfid & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sdv_serial::msg::TagRfid & msg)
{
  return sdv_serial::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sdv_serial::msg::TagRfid>()
{
  return "sdv_serial::msg::TagRfid";
}

template<>
inline const char * name<sdv_serial::msg::TagRfid>()
{
  return "sdv_serial/msg/TagRfid";
}

template<>
struct has_fixed_size<sdv_serial::msg::TagRfid>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<sdv_serial::msg::TagRfid>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<sdv_serial::msg::TagRfid>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SDV_SERIAL__MSG__DETAIL__TAG_RFID__TRAITS_HPP_
