...
#ifndef SDV_SERIAL__MSG__DETAIL__ENCODER__TRAITS_HPP_
#define SDV_SERIAL__MSG__DETAIL__ENCODER__TRAITS_HPP_
...
inline void to_yaml(
  const sdv_serial::msg::Encoder & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const sdv_serial::msg::Encoder & msg)
{
  return sdv_serial::msg::to_yaml(msg);
}

template<>
inline const char * data_type<sdv_serial::msg::Encoder>()
{
  return "sdv_serial::msg::Encoder";
}

template<>
inline const char * name<sdv_serial::msg::Encoder>()
{
  return "sdv_serial/msg/Encoder";
}

template<>
struct has_fixed_size<sdv_serial::msg::Encoder>
  : std::integral_constant<bool, has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<sdv_serial::msg::Encoder>
  : std::integral_constant<bool, has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<sdv_serial::msg::Encoder>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SDV_SERIAL__MSG__DETAIL__ENCODER__TRAITS_HPP_
