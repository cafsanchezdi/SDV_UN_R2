...
bool sdv_serial__msg__sdv_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_serial.msg._sdv_status.SdvStatus", full_classname_dest, 36) == 0);
  }
  sdv_serial__msg__SdvStatus * ros_message = _ros_message;
  {  // header
...
PyObject * sdv_serial__msg__sdv_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_serial.msg._sdv_status");
