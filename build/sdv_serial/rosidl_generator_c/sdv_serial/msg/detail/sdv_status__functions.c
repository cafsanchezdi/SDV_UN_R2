...
bool
sdv_serial__msg__SdvStatus__init(sdv_serial__msg__SdvStatus * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    sdv_serial__msg__SdvStatus__fini(msg);
    return false;
  }
  // energized
  // stand_by
...
void
sdv_serial__msg__SdvStatus__fini(sdv_serial__msg__SdvStatus * msg)
{
  if (!msg) {
    return;
  }
...
bool
sdv_serial__msg__SdvStatus__are_equal(const sdv_serial__msg__SdvStatus * lhs, const sdv_serial__msg__SdvStatus * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
sdv_serial__msg__SdvStatus__copy(
  const sdv_serial__msg__SdvStatus * input,
  sdv_serial__msg__SdvStatus * output)
{
  if (!input || !output) {
    return false;
  }
...
sdv_serial__msg__SdvStatus *
sdv_serial__msg__SdvStatus__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sdv_serial__msg__SdvStatus * msg = (sdv_serial__msg__SdvStatus *)allocator.allocate(sizeof(sdv_serial__msg__SdvStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sdv_serial__msg__SdvStatus));
  bool success = sdv_serial__msg__SdvStatus__init(msg);
  if (!success) {
...
void
sdv_serial__msg__SdvStatus__destroy(sdv_serial__msg__SdvStatus * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    sdv_serial__msg__SdvStatus__fini(msg);
...
bool
sdv_serial__msg__SdvStatus__Sequence__init(sdv_serial__msg__SdvStatus__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sdv_serial__msg__SdvStatus * data = NULL;

  if (size) {
    data = (sdv_serial__msg__SdvStatus *)allocator.zero_allocate(size, sizeof(sdv_serial__msg__SdvStatus), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sdv_serial__msg__SdvStatus__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sdv_serial__msg__SdvStatus__fini(&data[i - 1]);
      }
...
void
sdv_serial__msg__SdvStatus__Sequence__fini(sdv_serial__msg__SdvStatus__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sdv_serial__msg__SdvStatus__fini(&array->data[i]);
    }
...
sdv_serial__msg__SdvStatus__Sequence *
sdv_serial__msg__SdvStatus__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sdv_serial__msg__SdvStatus__Sequence * array = (sdv_serial__msg__SdvStatus__Sequence *)allocator.allocate(sizeof(sdv_serial__msg__SdvStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sdv_serial__msg__SdvStatus__Sequence__init(array, size);
  if (!success) {
...
void
sdv_serial__msg__SdvStatus__Sequence__destroy(sdv_serial__msg__SdvStatus__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sdv_serial__msg__SdvStatus__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
sdv_serial__msg__SdvStatus__Sequence__are_equal(const sdv_serial__msg__SdvStatus__Sequence * lhs, const sdv_serial__msg__SdvStatus__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sdv_serial__msg__SdvStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
sdv_serial__msg__SdvStatus__Sequence__copy(
  const sdv_serial__msg__SdvStatus__Sequence * input,
  sdv_serial__msg__SdvStatus__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sdv_serial__msg__SdvStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sdv_serial__msg__SdvStatus * data =
      (sdv_serial__msg__SdvStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sdv_serial__msg__SdvStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sdv_serial__msg__SdvStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sdv_serial__msg__SdvStatus__copy(
