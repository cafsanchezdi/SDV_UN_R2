...
{
  new (message_memory) sdv_serial::msg::Encoder(_init);
}

void Encoder_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sdv_serial::msg::Encoder *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Encoder_message_member_array[5] = {
  {
    ...
    offsetof(sdv_serial::msg::Encoder, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_serial::msg::Encoder, rpm_left),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_serial::msg::Encoder, rpm_right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_serial::msg::Encoder, motor_current_left),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sdv_serial::msg::Encoder, motor_current_right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::sdv_serial::msg::rosidl_typesupport_introspection_cpp::Encoder_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sdv_serial, msg, Encoder)() {
  return &::sdv_serial::msg::rosidl_typesupport_introspection_cpp::Encoder_message_type_support_handle;
}
