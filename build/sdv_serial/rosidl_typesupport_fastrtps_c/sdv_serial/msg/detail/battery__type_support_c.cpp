...
#include "sdv_serial/msg/detail/battery__rosidl_typesupport_fastrtps_c.h"
...
using _Battery__ros_msg_type = sdv_serial__msg__Battery;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
bool cdr_serialize_sdv_serial__msg__Battery(
  const sdv_serial__msg__Battery * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: current_main
  {
    cdr << ros_message->current_main;
  }

  // Field name: voltage_main
  {
    cdr << ros_message->voltage_main;
  }

  // Field name: current_laser
  {
    cdr << ros_message->current_laser;
  }

  // Field name: voltage_laser
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
bool cdr_deserialize_sdv_serial__msg__Battery(
  eprosima::fastcdr::Cdr & cdr,
  sdv_serial__msg__Battery * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
size_t get_serialized_size_sdv_serial__msg__Battery(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
size_t max_serialized_size_sdv_serial__msg__Battery(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_serial__msg__Battery;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
bool cdr_serialize_key_sdv_serial__msg__Battery(
  const sdv_serial__msg__Battery * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
size_t get_serialized_size_key_sdv_serial__msg__Battery(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Battery__ros_msg_type * ros_message = static_cast<const _Battery__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
size_t max_serialized_size_key_sdv_serial__msg__Battery(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sdv_serial__msg__Battery * ros_message = static_cast<const sdv_serial__msg__Battery *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sdv_serial__msg__Battery(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sdv_serial__msg__Battery * ros_message = static_cast<sdv_serial__msg__Battery *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sdv_serial__msg__Battery(cdr, ros_message);
}

static uint32_t _Battery__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_serial__msg__Battery(
...
static size_t _Battery__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_serial__msg__Battery(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sdv_serial, msg, Battery)() {
