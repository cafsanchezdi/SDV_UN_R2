...
#include "sdv_serial/msg/detail/tag_rfid__rosidl_typesupport_fastrtps_c.h"
...
using _TagRfid__ros_msg_type = sdv_serial__msg__TagRfid;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
bool cdr_serialize_sdv_serial__msg__TagRfid(
  const sdv_serial__msg__TagRfid * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
bool cdr_deserialize_sdv_serial__msg__TagRfid(
  eprosima::fastcdr::Cdr & cdr,
  sdv_serial__msg__TagRfid * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
size_t get_serialized_size_sdv_serial__msg__TagRfid(
  const void * untyped_ros_message,
  size_t current_alignment)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
size_t max_serialized_size_sdv_serial__msg__TagRfid(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_serial__msg__TagRfid;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
bool cdr_serialize_key_sdv_serial__msg__TagRfid(
  const sdv_serial__msg__TagRfid * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
size_t get_serialized_size_key_sdv_serial__msg__TagRfid(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TagRfid__ros_msg_type * ros_message = static_cast<const _TagRfid__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_sdv_serial
size_t max_serialized_size_key_sdv_serial__msg__TagRfid(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sdv_serial__msg__TagRfid * ros_message = static_cast<const sdv_serial__msg__TagRfid *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sdv_serial__msg__TagRfid(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sdv_serial__msg__TagRfid * ros_message = static_cast<sdv_serial__msg__TagRfid *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sdv_serial__msg__TagRfid(cdr, ros_message);
}

static uint32_t _TagRfid__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_serial__msg__TagRfid(
...
static size_t _TagRfid__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_serial__msg__TagRfid(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sdv_serial, msg, TagRfid)() {
