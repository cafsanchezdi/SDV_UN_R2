...
#include "sdv_serial/msg/detail/motors__rosidl_typesupport_fastrtps_c.h"
...
using _Motors__ros_msg_type = sdv_serial__msg__Motors;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: left_percent
  {
    cdr << ros_message->left_percent;
  }

  // Field name: right_percent
  {
    cdr << ros_message->right_percent;
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: left_percent
  {
    size_t item_size = sizeof(ros_message->left_percent);
  ...
  // Field name: right_percent
  {
    size_t item_size = sizeof(ros_message->right_percent);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_serial__msg__Motors;
    is_plain =
      (
      offsetof(DataType, right_percent) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sdv_serial__msg__Motors * ros_message = static_cast<const sdv_serial__msg__Motors *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sdv_serial__msg__Motors(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sdv_serial__msg__Motors * ros_message = static_cast<sdv_serial__msg__Motors *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sdv_serial__msg__Motors(cdr, ros_message);
}

static uint32_t _Motors__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_serial__msg__Motors(
...
static size_t _Motors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_serial__msg__Motors(
