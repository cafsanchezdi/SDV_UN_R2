...
#include "sdv_process/msg/detail/firebase_process__rosidl_typesupport_fastrtps_c.h"
...
using _FirebaseProcess__ros_msg_type = sdv_process__msg__FirebaseProcess;
...
{
  const _FirebaseProcess__ros_msg_type * ros_message = static_cast<const _FirebaseProcess__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sdv_process__msg__FirebaseProcess;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sdv_process__msg__FirebaseProcess * ros_message = static_cast<const sdv_process__msg__FirebaseProcess *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sdv_process__msg__FirebaseProcess(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sdv_process__msg__FirebaseProcess * ros_message = static_cast<sdv_process__msg__FirebaseProcess *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sdv_process__msg__FirebaseProcess(cdr, ros_message);
}

static uint32_t _FirebaseProcess__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sdv_process__msg__FirebaseProcess(
...
static size_t _FirebaseProcess__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sdv_process__msg__FirebaseProcess(
...
static message_type_support_callbacks_t __callbacks_FirebaseProcess = {
  "sdv_process::msg",
  "FirebaseProcess",
...
static rosidl_message_type_support_t _FirebaseProcess__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_FirebaseProcess,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sdv_process, msg, FirebaseProcess)() {
  return &_FirebaseProcess__type_support;
}
