...
bool sdv_process__msg__firebase_process__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sdv_process.msg._firebase_process.FirebaseProcess", full_classname_dest, 49) == 0);
  }
  sdv_process__msg__FirebaseProcess * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of FirebaseProcess */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("sdv_process.msg._firebase_process");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FirebaseProcess");
